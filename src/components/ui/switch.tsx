...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      "peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-all duration-200 ease-in-out",
      ...
      "hover:data-[state=unchecked]:bg-input/80 dark:hover:data-[state=unchecked]:bg-muted/80",
